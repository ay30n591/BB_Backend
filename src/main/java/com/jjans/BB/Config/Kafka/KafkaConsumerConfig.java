...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ChatDto> consumerFactory(){
        return new DefaultKafkaConsumerFactory<>(consumerConfigurations(), new StringDeserializer(),
                new JsonDeserializer<>(ChatDto.class));
    }
    ...
    private Map<String, Object> consumerConfigurations() {
        ...
        configurations.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, deserializerKey);
        configurations.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, deserializerValue);
